...
date: Thu, 16 Oct 2025 01:25:13 GMT
---
...
Switches are best used for communicating activation (e.g. on/off states), while [checkboxes](https://react-spectrum.adobe.com/react-spectrum/Checkbox.html) are best used for communicating selection (e.g. multiple table rows). Switches, unlike checkboxes, can't have an error state.
